...
void print(theIterator begin, theIterator end);
...
void print(theIterator begin, theIterator end) {
    ...
    if (end - begin <= showNums) {
        ...
        for (auto i = begin; i != begin + showNums / 2; ++i) {
            cout << *i << ", ";
        }
        cout << "......, ";
        for (auto i = end - showNums / 2; i != end; ++i) {
            cout << *i << ", ";
        }
        cout << endl;
    }
...
int main() {
    ...
    cout << "using GPU, consuming time = " << (end - start) * 1000.0 / CLOCKS_PER_SEC << " ms" << endl;
    cout << "after sort, A = ";
    print(A.begin(), A.end());
    ...
    cout << "using CPU, consuming time = " << (end - start) * 1000.0 / CLOCKS_PER_SEC << " ms" << endl;
    cout << "after sort, B = ";
    print(B.begin(), B.end());
    ...
    cout << "using CPU, stl::stable_sort, consuming time = " << (end - start) * 1000.0 / CLOCKS_PER_SEC << " ms" << endl;
    cout << "after sort, C = ";
    print(C.begin(), C.end());
